...
## Project Structure
    ...
    ├── qr_code_scanner_app_32359  # Django project configurations
...
1. Clone this repo and `cd qr_code_scanner_app_32359`
...
2. Clone this repo and `cd qr_code_scanner_app_32359`
